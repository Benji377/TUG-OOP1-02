...
class CSVParser {
  public:
    static const std::string ARMOR_CSV_PATH;
    static const std::string POTIONS_CSV_PATH;
    static const std::string WEAPON_CSV_PATH;
    static const std::string AMMUNITION_CSV_PATH;
    ///----------------------------------------------------------------------------------------------------------------
    ///
